...
#create the app
auth0 apps create --name myapp --description myapp --type regular --callbacks https://oauth-bookinfo-istio-ingress.apps.cluster-tlkwm.dynamic.redhatworkshops.io/oauth2/callback
