...
```sh
tbox@fedora:~/git/trevorbox/openshift-service-mesh$ curl -k -s -H 'X-Forwarded-For: 56.5.6.7, 72.9.5.6, 98.1.2.3' "https://golang-ex-featurea-istio-ingress.apps.cluster-slvqp.slvqp.sandbox125.opentlc.com//"
{
 "RequestHeaders": {
  "Accept": [
   "*/*"
...
```sh
tbox@fedora:~/git/trevorbox/openshift-service-mesh$ curl -k -s -H 'X-Forwarded-For: 56.5.6.7, 72.9.5.6, 98.1.2.3' "https://golang-ex-edge-istio-ingress.apps.cluster-slvqp.slvqp.sandbox125.opentlc.com//"
{
 "RequestHeaders": {
  "Accept": [
   "*/*"
  ...
  "Forwarded": [
   "for=192.168.130.1;host=golang-ex-edge-istio-ingress.apps.cluster-slvqp.slvqp.sandbox125.opentlc.com/;proto=https"
  ],
  "Traceparent": [
  ...
  "X-Forwarded-Host": [
   "golang-ex-edge-istio-ingress.apps.cluster-slvqp.slvqp.sandbox125.opentlc.com/"
  ],
  "X-Forwarded-Port": [
   "443"
  ],
...
```logs
[2025-02-08T00:14:22.582Z] "GET / HTTP/1.1" 200 - via_upstream - "-" 0 1651 3 3 "192.168.130.1,10.217.0.2" "curl/8.6.0" "6965ab38-54da-9c39-84ae-29464b4e6c47" "golang-ex-edge-istio-ingress.apps.cluster-slvqp.slvqp.sandbox125.opentlc.com/" "10.217.0.203:8080" outbound|8080||golang-ex-featurea.golang-ex.svc.cluster.local 10.217.1.78:50610 10.217.1.78:8080 192.168.130.1:0 - -
2025-02-08T00:15:19.831579Z debug envoy rbac external/envoy/source/extensions/filters/http/rbac/rbac_filter.cc:114 checking request: requestedServerName: , sourceIP: 10.217.0.2:48052, directRemoteIP: 10.217.0.2:48052, remoteIP: 192.168.130.1:0,localAddress: 10.217.1.78:8080, ssl: none, headers: ':authority', 'golang-ex-edge-istio-ingress.apps.cluster-slvqp.slvqp.sandbox125.opentlc.com/'
':path', '/'
':method', 'GET'
':scheme', 'https'
...
'x-forwarded-host', 'golang-ex-edge-istio-ingress.apps.cluster-slvqp.slvqp.sandbox125.opentlc.com/'
'x-forwarded-port', '443'
'x-forwarded-proto', 'https'
'forwarded', 'for=192.168.130.1;host=golang-ex-edge-istio-ingress.apps.cluster-slvqp.slvqp.sandbox125.opentlc.com/;proto=https'
...
tbox@fedora:~/git/trevorbox/openshift-service-mesh$ curl -k --resolve golang-ex-featurea-istio-ingress.apps.cluster-slvqp.slvqp.sandbox125.opentlc.com/:31938:198.168.130.11 https://golang-ex-featurea-istio-ingress.apps.cluster-slvqp.slvqp.sandbox125.opentlc.com/
{
 "request_headers": {
  "Accept": [
   "*/*"
