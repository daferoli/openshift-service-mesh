...
bookinfo             bookinfo-istio-ingress.apps.cluster-nbhrp.dynamic.redhatworkshops.io                    istio-ingressgateway   https   passthrough/Redirect   None
golang-ex-edge       golang-ex-edge-istio-ingress.apps.cluster-nbhrp.dynamic.redhatworkshops.io              istio-ingressgateway   http2   edge/Redirect          None
golang-ex-featurea   golang-ex-featurea-istio-ingress.apps.cluster-nbhrp.dynamic.redhatworkshops.io          istio-ingressgateway   https   passthrough/Redirect   None
golang-ex-high       golang-ex-high-istio-ingress.apps.cluster-nbhrp.dynamic.redhatworkshops.io              istio-ingressgateway   https   passthrough/Redirect   None
golang-ex-stable     golang-ex-stable-istio-ingress.apps.cluster-nbhrp.dynamic.redhatworkshops.io            istio-ingressgateway   https   passthrough/Redirect   None
nginx-echo-headers   nginx-echo-headers-istio-ingress.apps.cluster-nbhrp.dynamic.redhatworkshops.io          istio-ingressgateway   https   passthrough/Redirect   None
tbox@fedora:~$ curl -k https://bookinfo-istio-ingress.apps.cluster-nbhrp.dynamic.redhatworkshops.io/productpage
